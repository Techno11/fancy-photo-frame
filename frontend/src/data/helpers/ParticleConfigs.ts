export const Snow = {
  ...
  particles: { move: { speed: 1 }, wobble: { distance: 10 } },
};
export const Stars = { preset: "stars", background: { color: "#000" } };
export const Links = {
  preset: "links",
  particles: { move: { speed: 0.15 }, links: { color: "#00b" } },
};
...
export const Christmas: any = {
  preset: "stars",
  background: { color: "#000" },
  particles: {
    shape: {
      options: { char: { value: ["🎄"], font: "Verdana", fill: true } },
      type: "char",
    },
    size: { value: 15, random: { enable: true, minimumValue: 10 } },
  },
